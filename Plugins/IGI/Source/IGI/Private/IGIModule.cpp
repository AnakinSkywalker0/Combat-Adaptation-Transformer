...
bool FIGIModule::LoadIGICore()
{
    ...
    {
        UE_LOG(LogIGISDK, Error, TEXT("ERROR when loading IGI core"));
    }
    return Result;
}
...
bool FIGIModule::UnloadIGICore()
{
    ...
    {
        UE_LOG(LogIGISDK, Error, TEXT("ERROR when unloading IGI core"));
    }
    return Result;
}
...
nvigi::Result FIGIModule::LoadIGIFeature(const nvigi::PluginID& Feature, nvigi::InferenceInterface** Interface, const UTF8CHAR* UTF8PathToPlugin)
{
    ...
    {
        UE_LOG(LogIGISDK, Error, TEXT("ERROR when loading IGI feature: %s"), *GetIGIStatusString(Result));
    }
    return Result;
}
...
nvigi::Result FIGIModule::UnloadIGIFeature(const nvigi::PluginID& Feature, nvigi::InferenceInterface* Interface)
{
    ...
    {
        UE_LOG(LogIGISDK, Error, TEXT("ERROR when unloading IGI feature: %s"), *GetIGIStatusString(Result));
    }
    return Result;
}
